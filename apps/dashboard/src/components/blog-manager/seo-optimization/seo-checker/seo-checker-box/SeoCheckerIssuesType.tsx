...
const COLORS = {
  errors: '#EF4444', // tailwind red-500
  warnings: '#F59E0B', // tailwind amber-500
  notices: '#2563EB', // tailwind blue-600
  deltaUp: '#16A34A', // tailwind green-600
...
export default function SeoCheckerIssuesType() {
  return (
      ...
      <ul className="flex flex-col gap-3">
        <li className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="dark:text-neutral-200 font-medium">Errors</span>
          </div>
        ...
        <li className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-sm">
            <GrStatusGoodSmall className="text-yellow-500" size={12} />
            <span className="dark:text-neutral-200 font-medium">Warnings</span>
          </div>
          <div className="flex items-center gap-1 text-sm font-medium">
            <span className="text-blue-400">129</span>
            <IoMdArrowDropdown className="text-red-500" />
        ...
        <li className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-sm">
            <GrStatusGoodSmall className="text-blue-500" size={12} />
            <span className="dark:text-neutral-200 font-medium">Notices</span>
          </div>
          <div className="flex items-center gap-1 text-sm font-medium">
            <span className="text-blue-400">129</span>
            <IoMdArrowDropdown className="text-red-500" />
